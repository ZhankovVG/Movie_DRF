    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='movie.category', verbose_name='Категории')),
                ('directors', models.ManyToManyField(related_name='film_director', to='movie.actor', verbose_name='режисеры')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('star', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie.ratingsstar', verbose_name='звезда')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(verbose_name='Описание')),
                ('imege', models.ImageField(upload_to='movie_shots/', verbose_name='Изображение')),
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie.movie', verbose_name='Фильм')),
            ],
            options={
